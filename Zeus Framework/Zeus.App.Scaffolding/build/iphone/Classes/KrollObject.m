 ...
 * Copyright (c) 2009-2011 by ZeusApp, Inc. All Rights Reserved.
...
//@interface ZeusAppObject : NSObject
//@end

@interface ZeusAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ZeusAppObject class]])
		{
			for (NSString *key in [[(ZeusAppObject*)o modules] allKeys])
			{
