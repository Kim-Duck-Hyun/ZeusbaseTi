...
// in simulator we redefine to format for ZeusApp Developer console
...
{\
	NSString * exceptionName = [@"org.zeusapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.zeusapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIZeusAppNativeItemNone = -1, 
	UIZeusAppNativeItemSpinner = -2,
	UIZeusAppNativeItemProgressBar = -3,
	
	UIZeusAppNativeItemSlider = -4,
	UIZeusAppNativeItemSwitch = -5,
	UIZeusAppNativeItemMultiButton = -6,
	UIZeusAppNativeItemSegmented = -7,
	
	UIZeusAppNativeItemTextView = -8,
	UIZeusAppNativeItemTextField = -9,
	UIZeusAppNativeItemSearchBar = -10,
	
	UIZeusAppNativeItemPicker = -11,
	UIZeusAppNativeItemDatePicker = -12,
	
	UIZeusAppNativeItemInfoLight = -13,
	UIZeusAppNativeItemInfoDark = -14,
	
	UIZeusAppNativeItemDisclosure = -15,
	
	UIZeusAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ZeusApp instances of
