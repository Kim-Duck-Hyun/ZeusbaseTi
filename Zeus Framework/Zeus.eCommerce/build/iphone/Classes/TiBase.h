...
// in simulator we redefine to format for ZeuseCommerce Developer console
...
{\
	NSString * exceptionName = [@"org.zeusecommerce." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.zeusecommerce";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIZeuseCommerceNativeItemNone = -1, 
	UIZeuseCommerceNativeItemSpinner = -2,
	UIZeuseCommerceNativeItemProgressBar = -3,
	
	UIZeuseCommerceNativeItemSlider = -4,
	UIZeuseCommerceNativeItemSwitch = -5,
	UIZeuseCommerceNativeItemMultiButton = -6,
	UIZeuseCommerceNativeItemSegmented = -7,
	
	UIZeuseCommerceNativeItemTextView = -8,
	UIZeuseCommerceNativeItemTextField = -9,
	UIZeuseCommerceNativeItemSearchBar = -10,
	
	UIZeuseCommerceNativeItemPicker = -11,
	UIZeuseCommerceNativeItemDatePicker = -12,
	
	UIZeuseCommerceNativeItemInfoLight = -13,
	UIZeuseCommerceNativeItemInfoDark = -14,
	
	UIZeuseCommerceNativeItemDisclosure = -15,
	
	UIZeuseCommerceNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ZeuseCommerce instances of
