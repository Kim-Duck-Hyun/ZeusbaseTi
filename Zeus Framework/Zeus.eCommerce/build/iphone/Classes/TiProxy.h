...
//Rare exceptions to indicate a bug in the _zeusecommerce code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ZeuseCommerce proxies.
 */
