 ...
 * Copyright (c) 2009-2011 by ZeuseCommerce, Inc. All Rights Reserved.
...
//@interface ZeuseCommerceObject : NSObject
//@end

@interface ZeuseCommerceObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ZeuseCommerceObject class]])
		{
			for (NSString *key in [[(ZeuseCommerceObject*)o modules] allKeys])
			{
