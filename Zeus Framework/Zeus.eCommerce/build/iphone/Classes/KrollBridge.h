...
@interface ZeuseCommerceObject : KrollCoverageObject {
#else
@interface ZeuseCommerceObject : KrollObject {
#endif
@private
...
extern NSString * ZeuseCommerce$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ZeuseCommerceObject *_zeusecommerce;
	BOOL shutdown;
