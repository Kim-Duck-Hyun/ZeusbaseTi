...
/**
 The base class for all ZeuseCommerce modules
 */
...
/**
 ZeuseCommerce Platform calls this method on startup.
 */
-(void)startup;

/**
 ZeuseCommerce Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 ZeuseCommerce Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 ZeuseCommerce Platform calls this method on resume.
 @param sender The sender of the event.
 */
