...
//Rare exceptions to indicate a bug in the _zeusbasefontawesome code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ZeusbaseFontawesome proxies.
 */
