...
// in simulator we redefine to format for ZeusbaseFontawesome Developer console
...
{\
	NSString * exceptionName = [@"org.zeusbasefontawesome." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.zeusbasefontawesome";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIZeusbaseFontawesomeNativeItemNone = -1, 
	UIZeusbaseFontawesomeNativeItemSpinner = -2,
	UIZeusbaseFontawesomeNativeItemProgressBar = -3,
	
	UIZeusbaseFontawesomeNativeItemSlider = -4,
	UIZeusbaseFontawesomeNativeItemSwitch = -5,
	UIZeusbaseFontawesomeNativeItemMultiButton = -6,
	UIZeusbaseFontawesomeNativeItemSegmented = -7,
	
	UIZeusbaseFontawesomeNativeItemTextView = -8,
	UIZeusbaseFontawesomeNativeItemTextField = -9,
	UIZeusbaseFontawesomeNativeItemSearchBar = -10,
	
	UIZeusbaseFontawesomeNativeItemPicker = -11,
	UIZeusbaseFontawesomeNativeItemDatePicker = -12,
	
	UIZeusbaseFontawesomeNativeItemInfoLight = -13,
	UIZeusbaseFontawesomeNativeItemInfoDark = -14,
	
	UIZeusbaseFontawesomeNativeItemDisclosure = -15,
	
	UIZeusbaseFontawesomeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ZeusbaseFontawesome instances of
