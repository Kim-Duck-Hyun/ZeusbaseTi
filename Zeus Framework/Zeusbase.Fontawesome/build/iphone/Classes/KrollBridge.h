...
@interface ZeusbaseFontawesomeObject : KrollCoverageObject {
#else
@interface ZeusbaseFontawesomeObject : KrollObject {
#endif
@private
...
extern NSString * ZeusbaseFontawesome$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ZeusbaseFontawesomeObject *_zeusbasefontawesome;
    KrollObject* console;
	BOOL shutdown;
