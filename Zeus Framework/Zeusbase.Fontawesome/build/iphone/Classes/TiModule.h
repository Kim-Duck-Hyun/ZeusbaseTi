...
/**
 The base class for all ZeusbaseFontawesome modules
 */
...
/**
 ZeusbaseFontawesome Platform calls this method on startup.
 */
-(void)startup;

/**
 ZeusbaseFontawesome Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 ZeusbaseFontawesome Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 ZeusbaseFontawesome Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 ZeusbaseFontawesome Platform calls this method on resume.
 @param sender The sender of the event.
 */
