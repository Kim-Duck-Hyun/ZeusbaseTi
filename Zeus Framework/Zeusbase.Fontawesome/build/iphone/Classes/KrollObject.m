 ...
 * Copyright (c) 2009-2012 by ZeusbaseFontawesome, Inc. All Rights Reserved.
...
//@interface ZeusbaseFontawesomeObject : NSObject
//@end

@interface ZeusbaseFontawesomeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ZeusbaseFontawesomeObject class]])
		{
			for (NSString *key in [[(ZeusbaseFontawesomeObject*)o modules] allKeys])
			{
