...
/**
 Base class for all ZeusbaseFontawesome views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ZeusbaseFontawesome view hierarchy (such as wrapped iOS UIViews) was touched.
