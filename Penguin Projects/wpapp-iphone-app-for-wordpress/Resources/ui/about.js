var winAbout = (function() {
    ...
    data[0].add(Ti.UI.createTableViewRow({title: l_about_contact_webmaster}));
    data[0].add(Ti.UI.createTableViewRow({title: l_about_tell_a_friend}));
    data[0].add(Ti.UI.createTableViewRow({title: l_about_visit_website}));
    data[1] = Ti.UI.createTableViewSection({});
    data[1].add(Ti.UI.createTableViewRow({title: l_about_terms_and_conditions}));
    data[1].add(Ti.UI.createTableViewRow({title: l_about_privacy_policy}));
    data[2] = Ti.UI.createTableViewSection({});
    data[2].add(Ti.UI.createTableViewRow({title: l_about_reset_data}));
