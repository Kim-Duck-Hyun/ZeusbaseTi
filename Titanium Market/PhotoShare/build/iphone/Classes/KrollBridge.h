...
@interface PhotoShareObject : KrollCoverageObject {
#else
@interface PhotoShareObject : KrollObject {
#endif
@private
...
extern NSString * PhotoShare$ModuleRequireFormat;
