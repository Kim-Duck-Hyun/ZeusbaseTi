 ...
 * Copyright (c) 2009-2012 by PhotoShare, Inc. All Rights Reserved.
...
//@interface PhotoShareObject : NSObject
//@end

@interface PhotoShareObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PhotoShareObject class]])
		{
			for (NSString *key in [[(PhotoShareObject*)o modules] allKeys])
			{
