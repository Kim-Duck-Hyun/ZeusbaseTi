...
// in simulator we redefine to format for PhotoShare Developer console
...
{\
	NSString * exceptionName = [@"org.photoshare." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.photoshare";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPhotoShareNativeItemNone = -1, 
	UIPhotoShareNativeItemSpinner = -2,
	UIPhotoShareNativeItemProgressBar = -3,
	
	UIPhotoShareNativeItemSlider = -4,
	UIPhotoShareNativeItemSwitch = -5,
	UIPhotoShareNativeItemMultiButton = -6,
	UIPhotoShareNativeItemSegmented = -7,
	
	UIPhotoShareNativeItemTextView = -8,
	UIPhotoShareNativeItemTextField = -9,
	UIPhotoShareNativeItemSearchBar = -10,
	
	UIPhotoShareNativeItemPicker = -11,
	UIPhotoShareNativeItemDatePicker = -12,
	
	UIPhotoShareNativeItemInfoLight = -13,
	UIPhotoShareNativeItemInfoDark = -14,
	
	UIPhotoShareNativeItemDisclosure = -15,
	
	UIPhotoShareNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all PhotoShare instances of
