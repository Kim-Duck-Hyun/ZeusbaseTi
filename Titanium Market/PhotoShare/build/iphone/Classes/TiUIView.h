...
/**
 Base class for all PhotoShare views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the PhotoShare view hierarchy (such as wrapped iOS UIViews) was touched.
