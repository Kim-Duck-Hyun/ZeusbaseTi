...
/**
 Base class for all GeoWebProject views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the GeoWebProject view hierarchy (such as wrapped iOS UIViews) was touched.
