...
@interface GeoWebProjectObject : KrollCoverageObject {
#else
@interface GeoWebProjectObject : KrollObject {
#endif
@private
...
extern NSString * GeoWebProject$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	GeoWebProjectObject *_geowebproject;
    KrollObject* console;
	BOOL shutdown;
