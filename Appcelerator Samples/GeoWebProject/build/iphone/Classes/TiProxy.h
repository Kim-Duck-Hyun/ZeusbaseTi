...
//Rare exceptions to indicate a bug in the _geowebproject code (Eg, function that a subclass should have implemented)
...
/**
 The base class for GeoWebProject proxies.
 */
