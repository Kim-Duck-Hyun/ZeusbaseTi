 ...
 * Copyright (c) 2009-2011 by GeoWebProject, Inc. All Rights Reserved.
...
//@interface GeoWebProjectObject : NSObject
//@end

@interface GeoWebProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GeoWebProjectObject class]])
		{
			for (NSString *key in [[(GeoWebProjectObject*)o modules] allKeys])
			{
