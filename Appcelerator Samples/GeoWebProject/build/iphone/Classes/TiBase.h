...
// in simulator we redefine to format for GeoWebProject Developer console
...
{\
	NSString * exceptionName = [@"org.geowebproject." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.geowebproject";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIGeoWebProjectNativeItemNone = -1, 
	UIGeoWebProjectNativeItemSpinner = -2,
	UIGeoWebProjectNativeItemProgressBar = -3,
	
	UIGeoWebProjectNativeItemSlider = -4,
	UIGeoWebProjectNativeItemSwitch = -5,
	UIGeoWebProjectNativeItemMultiButton = -6,
	UIGeoWebProjectNativeItemSegmented = -7,
	
	UIGeoWebProjectNativeItemTextView = -8,
	UIGeoWebProjectNativeItemTextField = -9,
	UIGeoWebProjectNativeItemSearchBar = -10,
	
	UIGeoWebProjectNativeItemPicker = -11,
	UIGeoWebProjectNativeItemDatePicker = -12,
	
	UIGeoWebProjectNativeItemInfoLight = -13,
	UIGeoWebProjectNativeItemInfoDark = -14,
	
	UIGeoWebProjectNativeItemDisclosure = -15,
	
	UIGeoWebProjectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all GeoWebProject instances of
