...
/**
 The base class for all Lab285 modules
 */
...
/**
 Lab285 Platform calls this method on startup.
 */
-(void)startup;

/**
 Lab285 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Lab285 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Lab285 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Lab285 Platform calls this method on resume.
 @param sender The sender of the event.
 */
