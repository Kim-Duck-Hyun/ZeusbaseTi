...
static NSString * const kLab285Javascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_lab285Injection
{
	...
	[html appendString:kLab285Javascript];
...
{
	// attempt to make well-formed HTML and inject in our Lab285 bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _lab285Injection]];
