...
// in simulator we redefine to format for Lab285 Developer console
...
{\
	NSString * exceptionName = [@"org.lab285." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.lab285";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UILab285NativeItemNone = -1, 
	UILab285NativeItemSpinner = -2,
	UILab285NativeItemProgressBar = -3,
	
	UILab285NativeItemSlider = -4,
	UILab285NativeItemSwitch = -5,
	UILab285NativeItemMultiButton = -6,
	UILab285NativeItemSegmented = -7,
	
	UILab285NativeItemTextView = -8,
	UILab285NativeItemTextField = -9,
	UILab285NativeItemSearchBar = -10,
	
	UILab285NativeItemPicker = -11,
	UILab285NativeItemDatePicker = -12,
	
	UILab285NativeItemInfoLight = -13,
	UILab285NativeItemInfoDark = -14,
	
	UILab285NativeItemDisclosure = -15,
	
	UILab285NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Lab285 instances of
