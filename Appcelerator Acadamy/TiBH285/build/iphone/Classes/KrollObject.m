 ...
 * Copyright (c) 2009-2011 by Lab285, Inc. All Rights Reserved.
...
//@interface Lab285Object : NSObject
//@end

@interface Lab285Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Lab285Object class]])
		{
			for (NSString *key in [[(Lab285Object*)o modules] allKeys])
			{
